...
var $author$project$Lobby$GetJSON = function (a) {
	return {$: 'GetJSON', a: a};
};
var $author$project$Lobby$Ping = function (a) {
	return {$: 'Ping', a: a};
};
...
var $author$project$Lobby$inputPort = _Platform_incomingPort('inputPort', $elm$json$Json$Decode$value);
var $author$project$Lobby$subscriptions = function (_v0) {
...
var $author$project$Lobby$GetUser = function (a) {
	return {$: 'GetUser', a: a};
};
var $author$project$Lobby$SetName = function (a) {
	return {$: 'SetName', a: a};
};
var $author$project$Lobby$JSONMessage = F2(
	function (action, content) {
		return {action: action, content: content};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Lobby$decodeJSON = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Lobby$JSONMessage,
...
var $author$project$Room$Room = F4(
	function (current_players, max_players, room_name, game_name) {
		return {current_players: current_players, game_name: game_name, max_players: max_players, room_name: room_name};
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Room$decodeRoom = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Room$Room,
	A2($elm$json$Json$Decode$field, 'current_players', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'max_players', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'room_name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'game_name', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Room$decodeRoomsList = $elm$json$Json$Decode$list($author$project$Room$decodeRoom);
...
var $author$project$Lobby$drawEmptyGameFilter = function (ignoredGames) {
	return A2($elm$core$Set$member, '', ignoredGames) ? A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('inactive'),
				$elm$html$Html$Events$onClick(
				$author$project$Lobby$SetIgnoredGames(
					A2($elm$core$Set$remove, '', ignoredGames)))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('Show rooms without games')
			])) : A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick(
				$author$project$Lobby$SetIgnoredGames(
					A2($elm$core$Set$insert, '', ignoredGames)))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('Show rooms without games')
...
var $author$project$Lobby$drawGameFilter = F2(
	function (ignoredGames, game) {
		return A2($elm$core$Set$member, game, ignoredGames) ? A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('inactive'),
					$elm$html$Html$Events$onClick(
					$author$project$Lobby$SetIgnoredGames(
						A2($elm$core$Set$remove, game, ignoredGames)))
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onClick(
					$author$project$Lobby$SetIgnoredGames(
						A2($elm$core$Set$insert, game, ignoredGames)))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(game)
...
var $author$project$Lobby$drawRoom = function (room) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('server_row')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(room.current_players) + ('/' + $elm$core$String$fromInt(room.max_players)))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(room.room_name)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(room.game_name)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('message--loading_rooms')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Loading rooms...')
								]))
						]))
				]);
		} else {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('message--no_rooms')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('There are no rooms to show!')
									]))
							]))
					]);
			} else {
				var rs = sortedRooms;
				return asc ? A2($elm$core$List$map, $author$project$Lobby$drawRoom, rs) : $elm$core$List$reverse(
					A2($elm$core$List$map, $author$project$Lobby$drawRoom, rs));
			}
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('sidebar_box sidebar_box--user')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										A2($elm$html$Html$Attributes$style, 'color', model.user.color)
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												A2($elm$html$Html$Attributes$attribute, 'tooltip', 'UID: ' + model.user.username),
												A2($elm$html$Html$Attributes$attribute, 'flow', 'right')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(model.user.nickname)
											])),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class(
										'settings__flexbox' + (model.toggleOptions ? '' : ' hidden'))
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Events$onInput($author$project$Lobby$SetName),
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onInput($author$project$Lobby$SetColor)
													]),
												_List_fromArray(
													[
														A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Attributes$class('submit button--big'),
														$elm$html$Html$Attributes$value('Update'),
														$elm$html$Html$Events$onClick($author$project$Lobby$UpdateSettings)
													]),
												_List_Nil)
											]))
									]))
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('sidebar_box sidebar_box--stats')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromInt(
											$author$project$Lobby$countRooms(model.rooms)) + ' rooms')
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(
											$author$project$Lobby$countPlayers(model.rooms)) + ' players')
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('sidebar_box sidebar_box--filter')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Filter Games')
									])),
								A2(
								$elm$html$Html$ul,
								_List_Nil,
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class(
												model.showFullRooms ? '' : 'inactive'),
												$elm$html$Html$Events$onClick($author$project$Lobby$ToggleShowFullRooms)
											]),
										_List_fromArray(
											[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('sidebar_box sidebar_box--debug')
							]),
						_List_fromArray(
							[
								A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('nav_space')
									]),
								_List_Nil),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('nav_box')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class(
												(model.toggleView === 'rooms') ? 'active' : ''),
												$elm$html$Html$Events$onClick(
												$author$project$Lobby$ToggleView('rooms'))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Rooms')
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class(
												(model.toggleView === 'games') ? 'active' : ''),
												$elm$html$Html$Events$onClick(
												$author$project$Lobby$ToggleView('games'))
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$Lobby$ToggleModal)
											]),
										_List_fromArray(
											[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class(
						'lightbox' + (model.toggleModal ? '' : ' hidden'))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('modal_row')
									]),
								_List_fromArray(
									[
										A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('No game (select one later)')
													])),
												A2(
												$elm$html$Html$option,
												_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('button--cancel button--big'),
												$elm$html$Html$Events$onClick($author$project$Lobby$ToggleModal)
											]),
										_List_fromArray(
											[
...
var $author$project$Lobby$main = $elm$browser$Browser$element(
	{init: $author$project$Lobby$init, subscriptions: $author$project$Lobby$subscriptions, update: $author$project$Lobby$update, view: $author$project$Lobby$view});
_Platform_export({'Lobby':{'init':$author$project$Lobby$main(
