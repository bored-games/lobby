...
view model =
  let
    server_table = div [ class "server_table" ]
      (List.concat
        [
    ...
    games_table = div [ class "games_table" ]
      [ div [ class "game game--canoe" ] [ h2 [] [ text "Canoe" ] ]
      , div [ class "game game--codenames" ] [ h2 [] [ text "Codenames" ] ]
      , div [ class "game game--robots" ] [ h2 [] [ text "Ricochet Robots" ] ] ]
  in
    div [ class "container" ]
    [ div [ class "sidebar" ]
    ...
    , div [ class "main" ]
      ...
      , if model.toggleView == "games" then games_table else server_table
      ]
